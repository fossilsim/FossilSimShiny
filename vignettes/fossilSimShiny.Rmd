...
vignette: >
  %\VignetteIndexEntry{fossilSimShiny}
...
* [Phylogenetic Tree]
  * [Generating a Tree]
  * [Importing a tree from the Newick format]
* [Generating Taxonomy]
* [Simulating Fossils]
...
*Note: if do not have a tree generated, go back to [Phylogenetic Tree]. Futhermore, if you wish to use a lineage-dependent model to simulate your fossils, it is recommended to generate the taxonomy first. Go to [Generating Taxonomy].*\
\
